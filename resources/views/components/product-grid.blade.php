...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    @foreach ($products['data']['data'] as $product)
        <div
            class="bg-white border rounded-lg shadow-md p-5 transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div class="mt-4">
                ...
                <p class="text-blue-600 font-bold mt-2 text-lg">Rp{{ number_format($product->price, 0, ',', '.') }}
                </p>
